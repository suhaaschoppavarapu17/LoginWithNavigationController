...
class ViewController: UIViewController {
    ...
    @IBAction func loginButtonTapped(_ sender: UIButton) {
        ...
        if username ==  "" && password == ""  {
            ...
            let alertAction = UIAlertAction(title: "Enter Credentials",
        ...
        if username != "suhaas" {
            let alertController = UIAlertController(title: "Wrong Credentials",
                                                    message: "Please enter valid Credentials",
                                                    preferredStyle: UIAlertController.Style.alert)
            
            let alertAction = UIAlertAction(title: "Enter valid Username",
                                            style: UIAlertAction.Style.cancel, handler: nil)
            ...
            let alertController = UIAlertController(title: "Wrong Credentials",
                                                    message: "Please enter valid Credentials",
                                                    preferredStyle: UIAlertController.Style.alert)
            let cancelAction = UIAlertAction(title: "Enter Correct Password",
                                             style: UIAlertAction.Style.cancel, handler: nil)
